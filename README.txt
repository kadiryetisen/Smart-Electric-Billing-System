In the smart electricity bill reporting system project,
the aim is to show the usage amount in kW to the user and convey the instant usage price
in any currency with the algorithm created based on the taxation information 
in the previous month's usage amount.
